...
ggplot(difference_map,
  ...
  labs(title = "Trump's Support in the Senate vs. Popular Electorate Support",
       subtitle = "Support for Trump's agenda from senators in states closer to white align more closely with how their consitituents voted for Trump",
...
statebins(difference_statebin, state_col = "state",
                     text_color = "black", value_col = "trump_senate_difference",
                     brewer_pal= "YlGn", font_size = 8, legend_title = "Percentage point difference", labels = c("-20 <> -9", "-8 <> +3", "+4 <> +15", "+16 <> +27", "+28 <> +40"),
          plot_title = "Trump's Support in the Senate vs. Popular Electorate Support",
          title_position = "top")
